...
#~/android-sdk/tools/bin/avdmanager create avd -n tester_ref --force -k "system-images;android-10;google_apis;x86" --device "2.7in QVGA" -c 200M
...
#~/android-sdk/tools/bin/avdmanager create avd -n tester_ref --force -k "system-images;android-10;google_apis;x86" --device "WVGA800" -c 200M
